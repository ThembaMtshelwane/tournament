...
const Modal = ({ toggle, setToggle }: Props) => {
  return (
    <>
      ...
      {toggle && (
        <>
          <section className="inset-0 text-sebg-secondary p-4 bg-black opacity-75 fixed"></section>
          <div className="border flex flex-col gap-4 items-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-white px-6 py-8 rounded-lg shadow-lg w-full max-w-[450px]">
            ...
            <IoClose
              className="absolute right-0  mx-8 size-8 text-sebg-secondary"
            ...
            <form className="w-full p-4 flex flex-col gap-4 ">
              <div className="flex flex-col gap-2">
                ...
                <input
                  className="border-sebg-secondary border p-2 rounded-lg"
                  required
                  type="text"
                  name="name"
                  id="name"
              ...
              <button className="bg-secondary rounded-lg p-4 text-white hover:bg-[#022040] transition">
                Continue
              </button>
            </form>
          </div>
